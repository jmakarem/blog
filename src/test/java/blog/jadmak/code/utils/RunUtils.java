...
public class RunUtils {
     ...
     *
     * <p>This method measures the time taken for the provided {@code Runnable} to execute.
     * It records the start time before running the task, records the end time after the task completes,
     * and then calculates and returns the elapsed time in milliseconds.
     *
